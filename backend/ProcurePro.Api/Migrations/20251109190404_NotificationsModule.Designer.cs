...
namespace ProcurePro.Api.Migrations
{
    ...
    [Migration("20251109190404_NotificationsModule")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProcurePro.Api.Modules.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ProcurePro.Api.Modules.Invoice", b =>
                {
                    b.HasOne("ProcurePro.Api.Modules.PurchaseOrder", "PurchaseOrder")
                        .WithMany()
            ...
            modelBuilder.Entity("ProcurePro.Api.Modules.PurchaseOrder", b =>
                {
                    ...
                    b.HasOne("ProcurePro.Api.Modules.VendorQuotation", "VendorQuotation")
                        ...
                        .HasForeignKey("ProcurePro.Api.Modules.PurchaseOrder", "VendorQuotationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("ProcurePro.Api.Modules.RFI", b =>
                {
                    b.HasOne("ProcurePro.Api.Modules.RFP", "RFP")
                        .WithMany("RFIs")
                        .HasForeignKey("RFPId")
